...
public class RiController {
    ...
    public String queryBookInfo(){
        ...
        //创建对应的http请求
        HttpGet httpGet = new HttpGet("http://localhost:8083/app/rizhi");
        //设置对应的请求参数
    ...
    public String deleterizhi(Integer rid){
        ...
        CloseableHttpClient httpclient = HttpClients.createDefault();
        //创建对应的http请求
        HttpDelete httpDelete = new HttpDelete("http://localhost:8083/app/rizhi/"+rid);
        //设置对应的请求参数
        try {
            //执行http请求 execute执行
    ...
    public String addrizhi(RiZhi riZhi){
        ...
        //创建httpclient对象 HttpClients httpclient的封装工具类
        //创建对应的http请求
        HttpPost httpPost = new HttpPost("http://localhost:8083/app/rizhi");
    ...
    public String updaterizhi(Integer rid,String rname,String rtype,String rtime){
        ...
        CloseableHttpClient httpclient = HttpClients.createDefault();
        //创建对应的http请求
        HttpPut  httpPut= new HttpPut("http://localhost:8083/app/rizhi/update");
