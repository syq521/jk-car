...
<table   border=1  >
		...
		<tr>
			<td>日志名称</td>
			<td><input type="text" name="rname" style="width: 280px;"
					   class="form-control input-sm" placeholder="日志名称" id="rname"/>
...
<table   border=1 >
	...
	<tr>
		<td>日志名称</td>
		<td><input type="text" name="rname" style="width: 280px;"
				   class="form-control input-sm" placeholder="日志名称" id="rname1"/>
